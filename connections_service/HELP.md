...
* The original package name 'com.SocioSkeleton.connections-service' is invalid and this project uses 'com.SocioSkeleton.connections_service' instead.
...
* [Spring Data Neo4j](https://docs.spring.io/spring-boot/3.3.7/reference/data/nosql.html#data.nosql.neo4j)
